...
def main():
    ...
    plt.plot(range(len(hist_xavier.history['loss'])), hist_xavier.history['loss'],label='xiver loss')
    plt.plot(range(len(hist_RandomNormal.history['loss'])), hist_RandomNormal.history['loss'],label='random loss')
    plt.plot(range(len(hist_he.history['loss'])), hist_he.history['loss'],label='he normal loss')
    plt.plot(range(len(hist_xavier.history['accuracy'])), hist_xavier.history['accuracy'],label='xiver acc')
    plt.plot(range(len(hist_RandomNormal.history['accuracy'])), hist_RandomNormal.history['accuracy'],label='random acc')
    plt.plot(range(len(hist_he.history['accuracy'])), hist_he.history['accuracy'],label='he normal acc')
    plt.legend()
    plt.show()
